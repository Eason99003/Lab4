...
#define USER_RAM_BASE 0x38000000

#define MPRJRAM_WORDS 1024
...
void main()
{
	...
	// --- Hard-coded copy of .mprjram payload from flash into BRAM ---
    int *src = (int *)FLASH_BASE;
    int *dst = (int *)USER_RAM_BASE;
    for (i = 0; i < MPRJRAM_WORDS; i++) {
        dst[i] = src[i];
    }  
